...
public class ApiCall {
	 ...
	 */
	public void add(boolean parameter) {
		parameters[ctParameters++] = new Variant(parameter);
	}
	 ...
	 * @param parameter the integer parameter.
	 */
	public void add(Integer parameter) {
		parameters[ctParameters++] = new Variant(parameter);
	}
	...
	/**
	 * Adds an array of booleans as a parameter.
	 * 
	 * @param parameter the array of booleans.
	 */
	public void add(boolean[] parameter) {
		parameters[ctParameters++] = new Variant(parameter);
	}
	...
	/**
	 * Adds an array of integers as a parameter.
	 * 
	 * @param parameter the array of integers.
	 */
	public void add(int[] parameter) {
		parameters[ctParameters++] = new Variant(parameter);
	}
	...
	/**
	 * Adds an array of doubles as a parameter.
	 * 
	 * @param parameter the array of doubles.
	 */
	public void add(double[] parameter) {
		parameters[ctParameters++] = new Variant(parameter);
	}
	...
	/**
	 * Adds an array of strings as a parameter.
	 * 
	 * @param parameter the array of strings.
	 */
	public void add(String[] parameter) {
		parameters[ctParameters++] = new Variant(parameter);
	}
